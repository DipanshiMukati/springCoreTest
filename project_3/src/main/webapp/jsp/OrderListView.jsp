			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="product" placeholder="Enter product"
						class="form-control"
						oninput="handleLetterInput(this, 'productError', 25)"
						onblur="validateLetterInput(this, 'productError', 25)"
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" name="quantity"
						...
						oninput="handleLetterInput(this, 'quantityError', 6)"
						onblur="handleLeIntergerInput(this, 'quantityError', 6)"
					...
					</span> <font color="red" class="pl-sm-5" id="quantityError"></font>
				</div>
				<div class="col-sm-2">


					<%
						String htmlList = HTMLUtility.getList1("customer", String.valueOf(dto.getCustomer()), map);
					%>

					<%=htmlList%>
					<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("customer", request)%></font>
				</div>
