...
<script src="<%=ORSView.APP_CONTEXT%>/js/utilites.js"></script>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="userId" placeholder="Enter userId"
						class="form-control"
						oninput="handleAlphanumericInput(this, 'userIdError', 30)"
						onblur="validateAlphanumericInput(this, 'userIdError', 30)"
