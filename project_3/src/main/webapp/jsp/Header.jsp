				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"> <i
							class="fas fa-car"></i>Add Inventory
						</a> <a class="dropdown-item" href="<%=ORSView.INVENTORY_LIST_CTL%>"><i
							class="fas fa-bars"></i>Inventory List</a>
					</div></li>
...
<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"> <i
							class="fas fa-car"></i>Add order
						</a> <a class="dropdown-item" href="<%=ORSView.ORDER_LIST_CTL%>"><i
							class="fas fa-bars"></i>order List</a>
					</div></li>
...
<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.TRADE_CTL%>"> <i
							class="fas fa-car"></i>Add Trade
						</a> <a class="dropdown-item" href="<%=ORSView.TRADE_LIST_CTL%>"><i
							class="fas fa-bars"></i>Trade List</a>
					</div></li>
				...
				<%-- 		  <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.STOCKANALYSIS_CTL%>"> <i
							class="fas fa-car"></i>Add StockAnalysis
						</a> <a class="dropdown-item" href="<%=ORSView.STOCKANALYSIS_LIST_CTL%>"><i
							class="fas fa-bars"></i>StockAnalysis List</a>
					</div></li> 
